...
import 'package:douban/route/route.dart';
...
//      home: DBRootPage(),
      ...
      routes: DBRoute.routes,
      onGenerateRoute: DBRoute.generateRoute,
      initialRoute: DBRoute.initialRoute,
      onUnknownRoute: DBRoute.unknownRoute
    );
  }
}
